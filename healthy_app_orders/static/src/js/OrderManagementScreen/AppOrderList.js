odoo.define('app_list.AppOrderList', function (require) {
    'use strict';
     ...
     */
    class AppOrderList extends PosComponent {
        constructor() {
            super(...arguments);
    ...
    AppOrderList.template = 'AppOrderList';

    Registries.Component.add(AppOrderList);
